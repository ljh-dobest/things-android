...
import com.aijia.videoteacher.adpater.BTDeviceListAdapter;
import com.aijia.videoteacher.utills.BrainUtils;
import com.aijia.videoteacher.view.DrawWaveView;
...
public class BrainLinkActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brain_link);
        ...
        public void onStatesChanged(int connectionStates) {
            ...
            switch (connectionStates) {
                case ConnectionStates.STATE_CONNECTED:
                    //sensor.start();
                    showToast("已连接", Toast.LENGTH_SHORT);
                    break;
    ...
    public void showToast(final String msg,final int timeStyle){
        BrainLinkActivity.this.runOnUiThread(new Runnable()
        {
            public void run()
            {
    ...
    private void setUpDeviceListView(){
        ...
        selectDialog.setOnCancelListener(new OnCancelListener(){
            ...
            public void onCancel(DialogInterface arg0) {
                ...
                BrainLinkActivity.this.unregisterReceiver(mReceiver);
            }
    ...
    public void bindToDevice(BluetoothDevice bd){
        ...
        if(bd.getBondState() != BluetoothDevice.BOND_BONDED){
            ...
            try {
                //Set pin
                if(BrainUtils.autoBond(bd.getClass(), bd, "0000")){
                    ispaired += 1;
                }
                //bind to device
                if(BrainUtils.createBond(bd.getClass(), bd)){
                    ispaired += 2;
                }
